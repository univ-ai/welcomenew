---
title: "AI-3 A" 
permalink: /aiexpress/ai3a/
kind: course
excerpt: Language Models I
sequence: 7
header:
...
You will start with the traditional language models such as RNNs, LSTM & GRUs and later move on to intermediate topics like word embeddings, which lay the foundations of the modern deep learning State-of-the-art architectures for NLP.
...
![](/assets/aiexpress/ai3a.assets/Content.png)
