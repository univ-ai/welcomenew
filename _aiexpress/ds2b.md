...
This course we provide you with the tools know how of using cloud computing for data processing and analysis. You will learn how to choose the right cloud services, manage data storage, and maintain security.



By the end of the course, students will be able to design and deploy data pipelines, data warehousing solutions, and machine learning models on cloud platforms.
...
You are expected to have basic programming experience and completed the course [DS2A: Databases](https://welcome.univ.ai/aiexpress/ds2a/) to sucessfully learn the contents of this course.
